...
count = length(total) - sum(total == 0)
RMSE_h = sqrt(sum((h_home$mids*100 - h_home$counts/total*100)^2, na.rm = T)/count)
RMSE_a = sqrt(sum(((100-h_away$mids*100) - h_away$counts/total*100)^2, na.rm = T)/count)
